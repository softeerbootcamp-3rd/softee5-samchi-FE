...
export const AddressPicker = (props: AddressPickerProps) => { 
    ...
    <div>
        ...
        <button style={{position:'absolute', left:'20px', top:'168px', width:'86px', height:'36px'}} onClick={()=>{props.setSelection('현대자동차 본사');props.setPage(props.page + 1);}} >
            <img src={`${process.env.PUBLIC_URL}/image/ButtonHome.png`}/>
        </button>
        <button style={{position:'absolute', left:'115px', top:'168px', width:'86px', height:'36px'}} onClick={()=>{props.setSelection('현대자동차 본사');props.setPage(props.page + 1);}} >
        <img src={`${process.env.PUBLIC_URL}/image/ButtonCompany.png`}/>
        </button>
        <button style={{position:'absolute', left:'196px', top:'168px', width:'86px', height:'36px'}} onClick={()=>{props.setSelection('현대자동차 본사');props.setPage(props.page + 1);}} >
        ...
        <button style={{position:'absolute', width:'375px', height:'64px', top:'256px', }} onClick={()=>{props.setSelection('현대자동차 본사');props.setPage(props.page + 1);}} >
        <img src={`${process.env.PUBLIC_URL}/image/AdressListItem.png`}/>
        </button>
        <button style={{position:'absolute', width:'375px', height:'64px', top:'322px', }} onClick={()=>{props.setSelection('현대자동차 본사');props.setPage(props.page + 1);}} >
        <img src={`${process.env.PUBLIC_URL}/image/AdressListItem.png`}/>
        </button>
        <button style={{position:'absolute', width:'375px', height:'64px', top:'388px', }} onClick={()=>{props.setSelection('현대자동차 본사');props.setPage(props.page + 1);}} >
        <img src={`${process.env.PUBLIC_URL}/image/AdressListItem.png`}/>
        </button>
        <button style={{position:'absolute', width:'375px', height:'64px', top:'454px', }} onClick={()=>{props.setSelection('현대자동차 본사');props.setPage(props.page + 1);}} >
        <img src={`${process.env.PUBLIC_URL}/image/AdressListItem.png`}/>
        </button>
        ...
        <button style={{position:'absolute', width:'375px', height:'64px', top:'580px', }} onClick={()=>{props.setSelection('현대자동차 본사');props.setPage(props.page + 1);}} >
            <img src={`${process.env.PUBLIC_URL}/image/ListTime.png`}  />
        </button>
        <button style={{position:'absolute', width:'375px', height:'64px', top:'646px', }} onClick={()=>{props.setSelection('현대자동차 본사');props.setPage(props.page + 1);}} >
        <img src={`${process.env.PUBLIC_URL}/image/ListTime.png`}  />
        </button>
        <button style={{position:'absolute', width:'375px', height:'64px', top:'712px', }} onClick={()=>{props.setSelection('현대자동차 본사');props.setPage(props.page + 1);}} >
        <img src={`${process.env.PUBLIC_URL}/image/ListTime.png`}  />
        </button>
        <button style={{position:'absolute', width:'375px', height:'64px', top:'778px', }} onClick={()=>{props.setSelection('현대자동차 본사');props.setPage(props.page + 1);}} >
        <img src={`${process.env.PUBLIC_URL}/image/ListTime.png`}  />
        </button>
