...
interface WaitProps extends Props{
    selection:number,
...
export const Wait = (props: WaitProps) => { 
    ...
    var dummy = setTimeout(()=>{props.setPage(()=>{return props.page + 1})}, 5000);

    useEffect(()=>{
        props.setPage(props.page + props.selection);
    }, [props.selection])
    ...
    <div id='wait'>
        ...
        <div id='Sheet' style={{position:'absolute', top:'396px', left:'0px', width:'100vw', height:'416px', boxShadow:'0px 0px 32px 0px', borderRadius:'24px 24px 0px 0px', backgroundColor:'#FFF'}}>
        ...
        <button 
            ...
            onClick={() => {clearTimeout(dummy); props.setSelection(-1); console.log(props.selection); props.setPage(props.page - 1)}} >
