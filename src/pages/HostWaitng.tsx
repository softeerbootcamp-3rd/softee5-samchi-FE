...
export const HostWaiting = (props: HostWaitingProps) => { 
    ...
    setTimeout(() => {props.setPage(props.page + 1)}, 5000);
    ...
    <div id='hostwaiting'>
        ...
        <div style={{position:'absolute', bottom:'0vw', left:'0px', width:'100vw', height:'300px', boxShadow:'0px 0px 32px 0px', borderRadius:'24px 24px 0px 0px', backgroundColor:'#FFF'}}>
            ...
            <p style={{position:'absolute', top:'48px', left:'80px', fontSize:'16px', fontWeight:700, lineHeight:'150%', color:'#1C1C1C'}}>동승자</p>
            <p style={{position:'absolute', top:'74px', left:'80px', fontSize:'14px', fontWeight:400, lineHeight:'150%', color:'#757575'}}>Drive Agora ??회</p>
