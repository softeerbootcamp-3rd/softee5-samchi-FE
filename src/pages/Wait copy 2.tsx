    ...
    <div id='wait'>
        ...
        <button 
            ...
            onClick={() => {props.setSelection(-2); console.log(props.selection); props.setPage(props.page + 1)}} >
                <p style={{ top:'16px', height:'20px',  wordWrap: 'break-word', textAlign: 'center', color: 'white', fontSize:'14px', fontFamily: 'Pretendard', fontWeight: '700', lineHeight:'20px', letterSpacing:'-0.25px'}}>취소하기</p>
        </button>
    </div>
    );
}