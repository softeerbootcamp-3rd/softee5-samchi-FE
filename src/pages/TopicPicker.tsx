...
export const TopicPicker = (props:TopicPickerProps) => {
    ...
    return (
        ...
        <button 
            ...
            onClick={()=>props.setSelection(props.selection.map((v, i)=>{return false;}))}>
        ...
        onClick={()=>props.setSelection(props.selection.map((v, i)=>{if(0 === i) return true; else return false;}))}>
        ...
        <button 
            ...
            onClick={()=>props.setSelection(props.selection.map((v, i)=>{if (1 === i) {return !v;} else {if(0 === i) return false; return v;}}))}>
        ...
        <button 
            ...
            onClick={()=>props.setSelection(props.selection.map((v, i)=>{if (2 === i) {return !v;} else {if(0 === i) return false; return v;}}))}>
        ...
        <button 
            ...
            onClick={()=>props.setSelection(props.selection.map((v, i)=>{if (3 === i) {return !v;} else {if(0 === i) return false; return v;}}))}>
        ...
        <button 
            ...
            onClick={()=>props.setSelection(props.selection.map((v, i)=>{if (4 === i) {return !v;} else {if(0 === i) return false; return v;}}))}>
        ...
        <button 
            ...
            onClick={()=>props.setSelection(props.selection.map((v, i)=>{if (5 === i) {return !v;} else {if(0 === i) return false; return v;}}))}>
        ...
        <button 
            ...
            onClick={()=>props.setSelection(props.selection.map((v, i)=>{if (6 === i) {return !v;} else {if(0 === i) return false; return v;}}))}>
        ...
        <button 
            ...
            onClick={()=>props.setSelection(props.selection.map((v, i)=>{if (7 === i) {return !v;} else {if(0 === i) return false; return v;}}))}>
        ...
        <button 
            ...
            onClick={()=>props.setSelection(props.selection.map((v, i)=>{if (8 === i) {return !v;} else {if(0 === i) return false; return v;}}))}>
