...
export const AfterDrive = (props: AfterDriveProps) => { 
    ...
    <div id='afterdrive'>
        ...
        <div id='sheet' style={{position:'absolute', bottom:'0px', left:'0px', width:'375px', height:'694px', boxShadow:'0px 0px 32px 0px', borderRadius:'24px 24px 0px 0px', backgroundColor:'#FFF'}}>
